...
exports.createNewExpense = exports.getAllExpenses = void 0;
const expensePrompts_1 = require("./expensePrompts");
...
const createNewExpense = () => __awaiter(void 0, void 0, void 0, function* () {
    const newExpenseData = yield (0, expensePrompts_1.newExpensePrompt)();
    const currentExpenses = yield (0, fsMethods_1.getWithFS)("expenses");
